let pokemonRepository = (function() {
    ...
    function r(e) {
        ...
        n.classList.add("pokemon-list-item"); // Changed to add the class pokemon-list-item
        let o = document.createElement("button");
        o.setAttribute("data-toggle", "modal"), o.setAttribute("data-target", "#exampleModalCenter"), o.innerText = e.name, o.classList.add("btn"), n.appendChild(o), t.appendChild(n), o.addEventListener("click", function() {
